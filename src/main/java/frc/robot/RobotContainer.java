...
import frc.robot.commands.ElevatorCommands.Coral_L2;
import frc.robot.commands.ElevatorCommands.Coral_L3;
import frc.robot.commands.ElevatorCommands.Coral_L4;
import frc.robot.commands.ElevatorCommands.IntakeAlgae_Floor;
import frc.robot.commands.ElevatorCommands.IntakeAlgae_High;
import frc.robot.commands.ElevatorCommands.IntakeAlgae_Low;
import frc.robot.commands.ElevatorCommands.IntakeCoral;
import frc.robot.commands.ElevatorCommands.ShootNet;
import frc.robot.commands.ElevatorCommands.ShootProcessor;
...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    operatorController.pov(90).whileTrue(new Coral_L2(m_ElevatorSubsystem, m_EffectorSubsystem));
