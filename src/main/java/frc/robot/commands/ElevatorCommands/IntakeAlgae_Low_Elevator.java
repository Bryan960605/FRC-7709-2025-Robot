...
public class IntakeAlgae_Low_Elevator extends Command {
  /** Creates a new IntakeAlgae_Low_Elevator. */
  private final ElevatorSubsystem m_ElevatorSubsystem;
  private final EndEffectorSubsystem m_EndEffectorSubsystem;
  public IntakeAlgae_Low_Elevator(ElevatorSubsystem ElevatorSubsystem, EndEffectorSubsystem endEffectorSubsystem) {
