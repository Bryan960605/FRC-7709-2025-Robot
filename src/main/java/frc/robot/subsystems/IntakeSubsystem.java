...
public class IntakeSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    if(getAngle() <= -129) {
      armFeedforward = new ArmFeedforward(IntakeConstants.armFeedforward_Ks4, IntakeConstants.armFeedforward_Kg4, IntakeConstants.armFeedforward_Kv4);
    }else if(getAngle() <= -106.5 && getAngle() >= -1181) {
      armFeedforward = new ArmFeedforward(IntakeConstants.armFeedforward_Ks3, IntakeConstants.armFeedforward_Kg3, IntakeConstants.armFeedforward_Kv3);
    }else if(getAngle() <= -84 && getAngle() >= -106.5) {
      armFeedforward = new ArmFeedforward(IntakeConstants.armFeedforward_Ks3, IntakeConstants.armFeedforward_Kg3, IntakeConstants.armFeedforward_Kv3);
    }else {
      armFeedforward = new ArmFeedforward(IntakeConstants.armFeedforward_Ks, IntakeConstants.armFeedforward_Kg, IntakeConstants.armFeedforward_Kv);
    }
    ...
    SmartDashboard.putNumber("Intake/absolutedPosition", getAbsolutePosition());
    SmartDashboard.putNumber("Intake/armAngle", getAngle());
